...
import { ValidateMassUploadResponseInterface } from 'src/interfaces/load/bulk-loading.interface';
...
export function validateMassUploadAdapter(
  ...
  if (!data || !('validateMassUpload' in data)) {
    ...
    return { validateMassUpload: { extension: '', file_size_bytes: 0, message: 'No data found', success: false } };
  }
